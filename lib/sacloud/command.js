...
/* commonServiceItems */
var commonsServiceItems = command.commonServiceItems = [
       'dns' , 
       'gslb' , 'gslb-http' , 'gslb-https' , 'gslb-tcp' , 'gslb-ping' , 
       'simplemon' , 'simplemon-http' , 'simplemon-https' , 'simplemon-tcp' , 'simplemon-ping'
];

/* resource */
var resources = command.resources = [
	'server', 'disk', 'archive', 'cdrom', 'switch', 'appliance', 'sshkey',
	'internet', 'ipaddress', 'subnet', 'interface', 'region', 'zone',
  'product/server', 'product/disk'
].concat(command.commonServiceItems);
...
var structure = command.structure = {
	create: {
		...
		archive      : ['zone', 'id:zone', 'size', 'p:size(GB)', 'name', 'p:name'],
		cdrom        : ['zone', 'id:zone', 'size', 'p:size(GB)', 'name', 'p:name'],
		...
		sshkey       : ['publickey', 'p:key', 'name', 'p:name'],
		dns          : ['dnszone','p:dnszone', 'name', 'p:name'],
		'gslb-http'  : ['path' , 'p:path' , 'status' , 'p:status' , 'name' , 'p:name' ],
    'gslb-https' : ['path' , 'p:path' , 'status' , 'p:status' , 'name' , 'p:name' ],
    'gslb-tcp'   : ['port' , 'p:port','name' , 'p:name' ],
    'gslb-ping'  : ['name' , 'p:name'],
    'simplemon-http'  : ['path' , 'p:path' , 'status' , 'p:status' , 'target' , 'p:target'],
    'simplemon-https' : ['path' , 'p:path' , 'status' , 'p:status' , 'target' , 'p:target'],
    'simplemon-tcp'   : ['port' , 'p:port' , 'target' , 'p:target'],
    'simplemon-ping'  : ['target' , 'p:target']
	},
	...
	show: {
		...
		zone     : ['id:zone'],
		sshkey   : ['id:sshkey'],
		dns      : ['id:commonserviceitem'],
		gslb     : ['id:commonserviceitem'],
		simplemon:['id:commonserviceitem']
	},

	update: {
		server   : ['id:server', 'p:options...'],
		disk     : ['id:disk', 'p:options...'],
		archive  : ['id:archive', 'p:options...'],
		cdrom    : ['id:cdrom', 'p:options...'],
		sshkey   : ['id:sshkey', 'p:options...'],
		'switch' : ['id:switch', 'p:options...']//,
		//ipaddress: ['id:ipaddress', 'p:options...']
	},
